...
class LessonScene(Scene):
    def construct(self):
        ...
        content = Text("Instead of just memorizing the quadratic formula, understanding its derivation using 'completing the square' provides de", font_size=25, color=GREY_A, line_spacing=0.9)
