...
class LessonScene(Scene):
    def construct(self):
        ...
        content = Text("Instead of just memorizing the Quadratic Formula, understanding its derivation through 'completing the square' builds a ", font_size=25, color=GREY_A, line_spacing=0.9)
