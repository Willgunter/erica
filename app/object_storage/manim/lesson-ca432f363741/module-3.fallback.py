...
class LessonScene(Scene):
    def construct(self):
        ...
        title = Text("Quadratic Formula's Geometric Meaning", font_size=52, color=BLUE_B, weight=BOLD)
        title.to_edge(UP)
        ...
        objective = Text("Understand and apply quadratic formula's geometric meaning", font_size=26, color=GREY_A)
        ...
        content = Text('Every quadratic equation, when written in function form as `y = ax^2 + bx + c`, corresponds visually to a parabola. The ', font_size=25, color=GREY_A, line_spacing=0.9)
        ...
        content = Text("Review the flashcards for Quadratic Formula's Geometric Meaning. Try to explain each concept back in your own words befo", font_size=25, color=GREY_A, line_spacing=0.9)
        content.next_to(step_title, DOWN, buff=0.5)
        frame = RoundedRectangle(corner_radius=0.18, width=12.2, height=2.3)
        frame.set_stroke(BLUE_D, width=2)
        frame.move_to(content)
