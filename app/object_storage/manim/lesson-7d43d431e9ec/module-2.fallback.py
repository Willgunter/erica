...
class LessonScene(Scene):
    def construct(self):
        ...
        content = Text("The quadratic formula isn't just a magical expression; it's derived systematically using a method called 'completing the", font_size=25, color=GREY_A, line_spacing=0.9)
