...
class LessonScene(Scene):
    def construct(self):
        ...
        content = Text('Beyond algebraic solutions, quadratic equations have a beautiful geometric meaning. When written as y = ax^2 + bx + c, t', font_size=25, color=GREY_A, line_spacing=0.9)
