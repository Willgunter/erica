...
class LessonScene(Scene):
    def construct(self):
        ...
        content = Text("Instead of merely memorizing the quadratic formula, understanding its derivation through 'completing the square' provide", font_size=25, color=GREY_A, line_spacing=0.9)
