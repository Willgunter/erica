...
class LessonScene(Scene):
    def construct(self):
        ...
        title = Text('Discriminant: Nature of Solutions', font_size=52, color=BLUE_B, weight=BOLD)
        title.to_edge(UP)
        ...
        objective = Text('Understand and apply discriminant: nature of solutions', font_size=26, color=GREY_A)
        ...
        content = Text('Inside the quadratic formula lies a critical expression, b^2 - 4ac, known as the discriminant. This single value holds t', font_size=25, color=GREY_A, line_spacing=0.9)
        ...
        content = Text('Review the flashcards for Discriminant: Nature of Solutions. Try to explain each concept back in your own words before f', font_size=25, color=GREY_A, line_spacing=0.9)
        content.next_to(step_title, DOWN, buff=0.5)
        frame = RoundedRectangle(corner_radius=0.18, width=12.2, height=2.3)
        frame.set_stroke(BLUE_D, width=2)
        frame.move_to(content)
