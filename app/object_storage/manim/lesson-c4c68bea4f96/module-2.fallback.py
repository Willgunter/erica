...
class LessonScene(Scene):
    def construct(self):
        ...
        title = Text('Derivation by Completing the Square', font_size=52, color=BLUE_B, weight=BOLD)
        title.to_edge(UP)
        ...
        objective = Text('Understand and apply derivation by completing the square', font_size=26, color=GREY_A)
        ...
        content = Text("The quadratic formula isn't just a mysterious rule; it can be derived directly from the general quadratic equation ax^2 ", font_size=25, color=GREY_A, line_spacing=0.9)
        ...
        content = Text('Review the flashcards for Derivation by Completing the Square. Try to explain each concept back in your own words before', font_size=25, color=GREY_A, line_spacing=0.9)
        content.next_to(step_title, DOWN, buff=0.5)
        frame = RoundedRectangle(corner_radius=0.18, width=12.2, height=2.3)
        frame.set_stroke(BLUE_D, width=2)
        frame.move_to(content)
