...
class LessonScene(Scene):
    def construct(self):
        ...
        content = Text("Quadratic equations aren't just abstract symbols; they represent parabolas graphically when written as y = ax² + bx + c.", font_size=25, color=GREY_A, line_spacing=0.9)
