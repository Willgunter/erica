...
class LessonScene(Scene):
    def construct(self):
        ...
        content = Text("The quadratic formula isn't just a memorized trick; it's systematically derived using a method called 'completing the sq", font_size=25, color=GREY_A, line_spacing=0.9)
