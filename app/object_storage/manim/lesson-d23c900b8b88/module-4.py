...
class LessonScene(Scene):
    def construct(self):
        ...
        content = Text('The discriminant, which is the expression b^2 - 4ac found *inside* the square root of the quadratic formula, is incredib', font_size=25, color=GREY_A, line_spacing=0.9)
