...
class LessonScene(Scene):
    def construct(self):
        ...
        content = Text('A quadratic equation is a polynomial equation of the second degree, meaning the highest exponent of the variable is 2. I', font_size=25, color=GREY_A, line_spacing=0.9)
