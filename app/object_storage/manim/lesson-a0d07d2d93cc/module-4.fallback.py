...
class LessonScene(Scene):
    def construct(self):
        ...
        title = Text('Ecological Roles and Natural Selection', font_size=52, color=BLUE_B, weight=BOLD)
        title.to_edge(UP)
        ...
        objective = Text('Understand and apply ecological roles and natural selection', font_size=26, color=GREY_A)
        ...
        content = Text('Ecosystems are defined by the interactions between living organisms and their environment, where energy flows through di', font_size=25, color=GREY_A, line_spacing=0.9)
        ...
        content = Text('Review the flashcards for Ecological Roles and Natural Selection. Try to explain each concept back in your own words bef', font_size=25, color=GREY_A, line_spacing=0.9)
        content.next_to(step_title, DOWN, buff=0.5)
        frame = RoundedRectangle(corner_radius=0.18, width=12.2, height=2.3)
        frame.set_stroke(BLUE_D, width=2)
        frame.move_to(content)
