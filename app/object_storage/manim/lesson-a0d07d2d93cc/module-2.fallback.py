...
class LessonScene(Scene):
    def construct(self):
        ...
        title = Text('DNA Structure, Inheritance, and Cell Division', font_size=52, color=BLUE_B, weight=BOLD)
        title.to_edge(UP)
        ...
        objective = Text('Understand and apply dna structure, inheritance, and cell division', font_size=26, color=GREY_A)
        ...
        content = Text('Genetics is the study of how traits are passed down through generations, primarily dictated by DNA, a double-helix molec', font_size=25, color=GREY_A, line_spacing=0.9)
        ...
        content = Text('Review the flashcards for DNA Structure, Inheritance, and Cell Division. Try to explain each concept back in your own wo', font_size=25, color=GREY_A, line_spacing=0.9)
        content.next_to(step_title, DOWN, buff=0.5)
        frame = RoundedRectangle(corner_radius=0.18, width=12.2, height=2.3)
        frame.set_stroke(BLUE_D, width=2)
        frame.move_to(content)
