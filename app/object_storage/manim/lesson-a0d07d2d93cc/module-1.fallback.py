...
class LessonScene(Scene):
    def construct(self):
        ...
        title = Text('Fundamental Cell Structure and Organelles', font_size=52, color=BLUE_B, weight=BOLD)
        title.to_edge(UP)
        ...
        objective = Text('Understand and apply fundamental cell structure and organelles', font_size=26, color=GREY_A)
        ...
        content = Text('Cells are the foundational units of all life, governed by the cell theory which states all organisms are made of cells, ', font_size=25, color=GREY_A, line_spacing=0.9)
        ...
        content = Text('Review the flashcards for Fundamental Cell Structure and Organelles. Try to explain each concept back in your own words ', font_size=25, color=GREY_A, line_spacing=0.9)
        content.next_to(step_title, DOWN, buff=0.5)
        frame = RoundedRectangle(corner_radius=0.18, width=12.2, height=2.3)
        frame.set_stroke(BLUE_D, width=2)
        frame.move_to(content)
