...
class LessonScene(Scene):
    def construct(self):
        ...
        content = Text("The quadratic formula isn't just a magical solution; it's systematically derived using a method called 'completing the s", font_size=25, color=GREY_A, line_spacing=0.9)
