...
class LessonScene(Scene):
    def construct(self):
        ...
        title = Text('Quadratic Equation Basics and Structure', font_size=52, color=BLUE_B, weight=BOLD)
        title.to_edge(UP)
        ...
        objective = Text('Understand and apply quadratic equation basics and structure', font_size=26, color=GREY_A)
        ...
        content = Text('A quadratic equation is a polynomial equation of degree two, commonly written in the general form ax^2 + bx + c = 0, whe', font_size=25, color=GREY_A, line_spacing=0.9)
        ...
        content = Text('Review the flashcards for Quadratic Equation Basics and Structure. Try to explain each concept back in your own words be', font_size=25, color=GREY_A, line_spacing=0.9)
        content.next_to(step_title, DOWN, buff=0.5)
        frame = RoundedRectangle(corner_radius=0.18, width=12.2, height=2.3)
        frame.set_stroke(BLUE_D, width=2)
        frame.move_to(content)
