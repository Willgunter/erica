...
class LessonScene(Scene):
    def construct(self):
        ...
        content = Text("Instead of just memorizing the quadratic formula, it's incredibly helpful to understand how it's derived using a method ", font_size=25, color=GREY_A, line_spacing=0.9)
