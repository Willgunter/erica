...
class LessonScene(Scene):
    def construct(self):
        ...
        title = Text('Analyzing Solutions with the Discriminant', font_size=52, color=BLUE_B, weight=BOLD)
        title.to_edge(UP)
        ...
        objective = Text('Understand and apply analyzing solutions with the discriminant', font_size=26, color=GREY_A)
        ...
        content = Text("The expression `b^2 - 4ac`, found inside the square root of the quadratic formula, is called the discriminant. It's a cr", font_size=25, color=GREY_A, line_spacing=0.9)
        ...
        content = Text('Review the flashcards for Analyzing Solutions with the Discriminant. Try to explain each concept back in your own words ', font_size=25, color=GREY_A, line_spacing=0.9)
        content.next_to(step_title, DOWN, buff=0.5)
        frame = RoundedRectangle(corner_radius=0.18, width=12.2, height=2.3)
        frame.set_stroke(BLUE_D, width=2)
        frame.move_to(content)
