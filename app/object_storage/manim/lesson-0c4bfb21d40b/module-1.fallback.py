...
class LessonScene(Scene):
    def construct(self):
        ...
        title = Text('Quadratic Formula Derivation: Completing the Square', font_size=52, color=BLUE_B, weight=BOLD)
        title.to_edge(UP)
        ...
        objective = Text('Understand and apply quadratic formula derivation: completing the square', font_size=26, color=GREY_A)
        ...
        content = Text('The quadratic formula, `x = (-b ± sqrt(b^2 - 4ac)) / (2a)`, is a powerful tool for solving any quadratic equation in the', font_size=25, color=GREY_A, line_spacing=0.9)
        ...
        content = Text('Review the flashcards for Quadratic Formula Derivation: Completing the Square. Try to explain each concept back in your ', font_size=25, color=GREY_A, line_spacing=0.9)
        content.next_to(step_title, DOWN, buff=0.5)
        frame = RoundedRectangle(corner_radius=0.18, width=12.2, height=2.3)
        frame.set_stroke(BLUE_D, width=2)
        frame.move_to(content)
