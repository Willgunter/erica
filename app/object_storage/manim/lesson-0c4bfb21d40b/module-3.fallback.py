...
class LessonScene(Scene):
    def construct(self):
        ...
        title = Text('Discriminant: Nature of Quadratic Solutions', font_size=52, color=BLUE_B, weight=BOLD)
        title.to_edge(UP)
        ...
        objective = Text('Understand and apply discriminant: nature of quadratic solutions', font_size=26, color=GREY_A)
        ...
        content = Text('The discriminant, `b^2 - 4ac`, is the powerful expression found under the square root in the quadratic formula. Its valu', font_size=25, color=GREY_A, line_spacing=0.9)
        ...
        content = Text('Review the flashcards for Discriminant: Nature of Quadratic Solutions. Try to explain each concept back in your own word', font_size=25, color=GREY_A, line_spacing=0.9)
        content.next_to(step_title, DOWN, buff=0.5)
        frame = RoundedRectangle(corner_radius=0.18, width=12.2, height=2.3)
        frame.set_stroke(BLUE_D, width=2)
        frame.move_to(content)
