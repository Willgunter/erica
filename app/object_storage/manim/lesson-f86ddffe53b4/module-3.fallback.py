...
class LessonScene(Scene):
    def construct(self):
        ...
        content = Text("Beyond just finding 'x' values, the quadratic formula offers a visual understanding of quadratic equations. When a quadr", font_size=25, color=GREY_A, line_spacing=0.9)
