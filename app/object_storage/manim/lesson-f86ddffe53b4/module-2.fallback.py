...
class LessonScene(Scene):
    def construct(self):
        ...
        content = Text("Understanding how the quadratic formula is derived, specifically through the method of 'completing the square,' deepens ", font_size=25, color=GREY_A, line_spacing=0.9)
