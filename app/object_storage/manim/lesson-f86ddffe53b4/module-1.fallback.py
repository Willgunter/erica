...
class LessonScene(Scene):
    def construct(self):
        ...
        content = Text('Quadratic equations are powerful tools used to describe curved paths and optimize problems, appearing in various physica', font_size=25, color=GREY_A, line_spacing=0.9)
