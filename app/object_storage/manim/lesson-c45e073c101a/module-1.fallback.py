...
class LessonScene(Scene):
    def construct(self):
        ...
        title = Text('General Form and Formula Derivation', font_size=52, color=BLUE_B, weight=BOLD)
        title.to_edge(UP)
        ...
        objective = Text('Understand and apply general form and formula derivation', font_size=26, color=GREY_A)
        ...
        content = Text("A quadratic equation is a polynomial of degree two, represented as `ax^2 + bx + c = 0`, where 'a' cannot be zero. Instea", font_size=25, color=GREY_A, line_spacing=0.9)
        ...
        content = Text('Review the flashcards for General Form and Formula Derivation. Try to explain each concept back in your own words before', font_size=25, color=GREY_A, line_spacing=0.9)
        content.next_to(step_title, DOWN, buff=0.5)
        frame = RoundedRectangle(corner_radius=0.18, width=12.2, height=2.3)
        frame.set_stroke(BLUE_D, width=2)
        frame.move_to(content)
