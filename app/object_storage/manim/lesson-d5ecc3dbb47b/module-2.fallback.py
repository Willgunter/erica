...
class LessonScene(Scene):
    def construct(self):
        ...
        title = Text('Formula Works Every Quadratic', font_size=52, color=BLUE_B, weight=BOLD)
        title.to_edge(UP)
        ...
        objective = Text('Understand and apply formula works every quadratic', font_size=26, color=GREY_A)
        ...
        content = Text('formula works for every quadratic equation, as long as a ≠ 0. Understanding the Formula Geometrically Every quadratic eq', font_size=25, color=GREY_A, line_spacing=0.9)
        ...
        content = Text('Review the flashcards for Formula Works Every Quadratic. Try to explain each concept back in your own words before flipp', font_size=25, color=GREY_A, line_spacing=0.9)
        content.next_to(step_title, DOWN, buff=0.5)
        frame = RoundedRectangle(corner_radius=0.18, width=12.2, height=2.3)
        frame.set_stroke(BLUE_D, width=2)
        frame.move_to(content)
