...
class LessonScene(Scene):
    def construct(self):
        ...
        content = Text('This module focuses on the practical application of the quadratic formula to find the solutions (or roots) of quadratic ', font_size=25, color=GREY_A, line_spacing=0.9)
