...
class LessonScene(Scene):
    def construct(self):
        ...
        title = Text('Defining and Deriving the Quadratic Formula', font_size=52, color=BLUE_B, weight=BOLD)
        title.to_edge(UP)
        ...
        objective = Text('Understand and apply defining and deriving the quadratic formula', font_size=26, color=GREY_A)
        ...
        content = Text('This module introduces the standard form of a quadratic equation and the powerful quadratic formula used to solve it. It', font_size=25, color=GREY_A, line_spacing=0.9)
        ...
        content = Text('Review the flashcards for Defining and Deriving the Quadratic Formula. Try to explain each concept back in your own word', font_size=25, color=GREY_A, line_spacing=0.9)
        content.next_to(step_title, DOWN, buff=0.5)
        frame = RoundedRectangle(corner_radius=0.18, width=12.2, height=2.3)
        frame.set_stroke(BLUE_D, width=2)
        frame.move_to(content)
