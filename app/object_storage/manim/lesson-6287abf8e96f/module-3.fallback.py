...
class LessonScene(Scene):
    def construct(self):
        ...
        content = Text('The quadratic formula, x = (-b ± sqrt(b^2 - 4ac)) / (2a), is a powerful tool that directly provides the solutions for an', font_size=25, color=GREY_A, line_spacing=0.9)
