...
class LessonScene(Scene):
    def construct(self):
        ...
        content = Text("We'll start with the fundamental unit of life – the cell! Understanding cell theory, which states that all living things", font_size=25, color=GREY_A, line_spacing=0.9)
