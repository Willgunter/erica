...
class LessonScene(Scene):
    def construct(self):
        ...
        title = Text('DNA, Heredity, and Cell Division', font_size=52, color=BLUE_B, weight=BOLD)
        title.to_edge(UP)
        ...
        objective = Text('Understand and apply dna, heredity, and cell division', font_size=26, color=GREY_A)
        ...
        content = Text("This module delves into how traits are passed down through generations. We'll explore DNA, the double-helix molecule car", font_size=25, color=GREY_A, line_spacing=0.9)
        ...
        content = Text('Review the flashcards for DNA, Heredity, and Cell Division. Try to explain each concept back in your own words before fl', font_size=25, color=GREY_A, line_spacing=0.9)
        content.next_to(step_title, DOWN, buff=0.5)
        frame = RoundedRectangle(corner_radius=0.18, width=12.2, height=2.3)
        frame.set_stroke(BLUE_D, width=2)
        frame.move_to(content)
