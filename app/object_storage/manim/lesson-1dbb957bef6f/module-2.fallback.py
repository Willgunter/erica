...
class LessonScene(Scene):
    def construct(self):
        ...
        title = Text('Step-by-Step Formula Derivation', font_size=52, color=BLUE_B, weight=BOLD)
        title.to_edge(UP)
        ...
        objective = Text('Understand and apply step-by-step formula derivation', font_size=26, color=GREY_A)
        ...
        content = Text("It's super helpful to know that the quadratic formula wasn't just pulled out of thin air! It's actually derived using a ", font_size=25, color=GREY_A, line_spacing=0.9)
        ...
        content = Text('Review the flashcards for Step-by-Step Formula Derivation. Try to explain each concept back in your own words before fli', font_size=25, color=GREY_A, line_spacing=0.9)
        content.next_to(step_title, DOWN, buff=0.5)
        frame = RoundedRectangle(corner_radius=0.18, width=12.2, height=2.3)
        frame.set_stroke(BLUE_D, width=2)
        frame.move_to(content)
