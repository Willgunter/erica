...
class LessonScene(Scene):
    def construct(self):
        ...
        content = Text('This module focuses on understanding how the quadratic formula is built from the general form ax^2 + bx + c = 0. Instead', font_size=25, color=GREY_A, line_spacing=0.9)
