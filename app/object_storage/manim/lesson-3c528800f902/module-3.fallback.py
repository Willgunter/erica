...
class LessonScene(Scene):
    def construct(self):
        ...
        title = Text('Graphing Solutions: Discriminant & X-intercepts', font_size=52, color=BLUE_B, weight=BOLD)
        title.to_edge(UP)
        ...
        objective = Text('Understand and apply graphing solutions: discriminant & x-intercepts', font_size=26, color=GREY_A)
        ...
        content = Text("The quadratic formula doesn't just give you numbers; it tells a story about the graph of the corresponding parabola, y =", font_size=25, color=GREY_A, line_spacing=0.9)
        ...
        content = Text('Review the flashcards for Graphing Solutions: Discriminant & X-intercepts. Try to explain each concept back in your own ', font_size=25, color=GREY_A, line_spacing=0.9)
        content.next_to(step_title, DOWN, buff=0.5)
        frame = RoundedRectangle(corner_radius=0.18, width=12.2, height=2.3)
        frame.set_stroke(BLUE_D, width=2)
        frame.move_to(content)
