...
class LessonScene(Scene):
    def construct(self):
        ...
        content = Text('Every quadratic equation corresponds graphically to a parabola when expressed as y = ax^2 + bx + c. The solutions derive', font_size=25, color=GREY_A, line_spacing=0.9)
