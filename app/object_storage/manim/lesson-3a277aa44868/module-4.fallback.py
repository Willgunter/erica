...
class LessonScene(Scene):
    def construct(self):
        ...
        content = Text("Within the quadratic formula, the expression b^2 - 4ac holds a special significance; it's called the discriminant. This ", font_size=25, color=GREY_A, line_spacing=0.9)
