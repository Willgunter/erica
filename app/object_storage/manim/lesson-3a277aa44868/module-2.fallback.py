...
class LessonScene(Scene):
    def construct(self):
        ...
        title = Text('Completing the Square Derivation', font_size=52, color=BLUE_B, weight=BOLD)
        title.to_edge(UP)
        ...
        objective = Text('Understand and apply completing the square derivation', font_size=26, color=GREY_A)
        ...
        content = Text("The quadratic formula isn't just a magical tool; it's derived systematically using a powerful algebraic technique called", font_size=25, color=GREY_A, line_spacing=0.9)
        ...
        content = Text('Review the flashcards for Completing the Square Derivation. Try to explain each concept back in your own words before fl', font_size=25, color=GREY_A, line_spacing=0.9)
        content.next_to(step_title, DOWN, buff=0.5)
        frame = RoundedRectangle(corner_radius=0.18, width=12.2, height=2.3)
        frame.set_stroke(BLUE_D, width=2)
        frame.move_to(content)
