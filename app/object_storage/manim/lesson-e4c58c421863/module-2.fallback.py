...
class LessonScene(Scene):
    def construct(self):
        ...
        content = Text("Now that you know where the formula comes from, let's focus on how to use it! The quadratic formula is a powerful tool t", font_size=25, color=GREY_A, line_spacing=0.9)
