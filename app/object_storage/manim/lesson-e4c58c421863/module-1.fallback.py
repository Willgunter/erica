...
class LessonScene(Scene):
    def construct(self):
        ...
        content = Text("This module breaks down how the quadratic formula is actually created, showing it's not just a random rule. By understan", font_size=25, color=GREY_A, line_spacing=0.9)
