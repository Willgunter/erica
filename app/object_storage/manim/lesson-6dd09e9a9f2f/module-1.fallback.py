...
class LessonScene(Scene):
    def construct(self):
        ...
        title = Text('Basic Cell Structure and Function', font_size=52, color=BLUE_B, weight=BOLD)
        title.to_edge(UP)
        ...
        objective = Text('Understand and apply basic cell structure and function', font_size=26, color=GREY_A)
        ...
        content = Text('All living organisms are fundamentally composed of cells, the smallest units of life, as outlined by Cell Theory. Cells ', font_size=25, color=GREY_A, line_spacing=0.9)
        ...
        content = Text('Review the flashcards for Basic Cell Structure and Function. Try to explain each concept back in your own words before f', font_size=25, color=GREY_A, line_spacing=0.9)
        content.next_to(step_title, DOWN, buff=0.5)
        frame = RoundedRectangle(corner_radius=0.18, width=12.2, height=2.3)
        frame.set_stroke(BLUE_D, width=2)
        frame.move_to(content)
