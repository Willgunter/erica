...
class LessonScene(Scene):
    def construct(self):
        ...
        title = Text("Understanding the Discriminant's Role", font_size=52, color=BLUE_B, weight=BOLD)
        title.to_edge(UP)
        ...
        objective = Text("Understand and apply understanding the discriminant's role", font_size=26, color=GREY_A)
        ...
        content = Text("The discriminant, b^2 - 4ac, is a small but mighty part of the Quadratic Formula. It's the expression found inside the s", font_size=25, color=GREY_A, line_spacing=0.9)
        ...
        content = Text("Review the flashcards for Understanding the Discriminant's Role. Try to explain each concept back in your own words befo", font_size=25, color=GREY_A, line_spacing=0.9)
        content.next_to(step_title, DOWN, buff=0.5)
        frame = RoundedRectangle(corner_radius=0.18, width=12.2, height=2.3)
        frame.set_stroke(BLUE_D, width=2)
        frame.move_to(content)
