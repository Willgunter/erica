...
class LessonScene(Scene):
    def construct(self):
        ...
        content = Text("The Quadratic Formula isn't magic; it's a result of a systematic algebraic process called 'completing the square'. This ", font_size=25, color=GREY_A, line_spacing=0.9)
